...
public class King : MonoBehaviour
{
    ...
    void Moves()
    {
        if (!selected)
        {
            Debug.Log("KING MOVES");
            StartCoroutine(Wait(true));

            Vector3 standard = new Vector3(gameObject.transform.position.x + side, 0, gameObject.transform.position.z + side);
            ...
            standard = new Vector3(gameObject.transform.position.x + side, 0, gameObject.transform.position.z - side);
            if (checkBounds(standard))
            {
                GameObject ind = Instantiate(indicator, standard, Quaternion.identity);
                moves.Add(ind);
            ...
            standard = new Vector3(gameObject.transform.position.x + side, 0, gameObject.transform.position.z);
            if (checkBounds(standard))
            {
                GameObject ind = Instantiate(indicator, standard, Quaternion.identity);
                moves.Add(ind);
            ...
            standard = new Vector3(gameObject.transform.position.x, 0, gameObject.transform.position.z + side);
            if (checkBounds(standard))
            {
                GameObject ind = Instantiate(indicator, standard, Quaternion.identity);
                moves.Add(ind);
